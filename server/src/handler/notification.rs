...
use crate::AppState;
use crate::notification::events::{NotificationMessage, SubscribeRequest, UnsubscribeRequest};
use crate::notification::manager::validate_notification_jwt;
...
async fn handle_read_msg(
    mgr: &crate::notification::manager::NotificationManager,
    client_id: u64,
    private_key: &str,
    last_pong: &AtomicI64,
    msg: Message,
